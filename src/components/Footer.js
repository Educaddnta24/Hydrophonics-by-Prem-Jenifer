        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-md-4 mb-3">
              <h5>About Us</h5>
              <p>
                We’re committed to revolutionizing agriculture through sustainable hydroponics. 
                From urban rooftops to rural farms, our systems empower communities to grow 
                fresh produce efficiently and responsibly.
              </p>
            </div>
          ...
          <div className="text-center">
            <p className="mb-0">© 2025 HydroFarm. All rights reserved.</p>
          </div>
